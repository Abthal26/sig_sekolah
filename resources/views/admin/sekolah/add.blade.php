...
@section('content')
    <x-app-layout>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="nama_sekolah" type="text" class="form-control" placeholder="Enter ...">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="kecamatan" type="text" class="form-control" placeholder="Enter ...">
                                    <div class="text-danger">
                                        @error('kecamatan')
                                            {{ $message }}
                                        @enderror
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="posisi" id="posisi" type="text" class="form-control"
                                        placeholder="Enter ...">
                                    <div class="text-danger">
                                        @error('posisi')
                                            {{ $message }}
        ...
        <script>
            ...
            var curLocation = [-6.297493214613195, 106.71312871708398];
